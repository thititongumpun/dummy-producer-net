...
// var names = new[] { "Shirley", "Zachary", "Ton", "Prem", "Prite", "Wave" };
...
//             PProctime = timestamp.ToString("yyyy-MM-dd HH:mm:ss'Z'", new System.Globalization.CultureInfo("en-US"))
//         };
...
//             PIProctime = timestamp.ToString("yyyy-MM-dd HH:mm:ss'Z'", new System.Globalization.CultureInfo("en-US"))
//         };
...
// {
//     await Init(20);
//     // await Task.WhenAll(ProduceMessageKafka(persons), ProduceMessageKafka(personsInfo), ProduceMessageKafka(persons), ProduceMessageKafka(personsInfo));
...
//     public string PProctime { get; set; } = default!;
// }
...
//     public string PIProctime { get; set; } = default!;
// }
